...
// cookie
   ...
   const nav =useNavigate()
    ...
    function handelsubmit(e) {
        e.preventDefault()
        setaccept(true)
        if (inputform.name === "" || inputform.password.length < 8) {
...
<button disabled={buttonhiden} >{buttonLoading ? <LoadingIcon /> : "Login"}</button>
<button onClick={handle} disabled={buttonhiden} >register</button>
</div>
